...
The directory currently shows **550** visible contributors across **43** public repos, representing **2537** merged PRs.

A few recently active contributors: @dylan-openhands, @enyst, @hxaxd, @luciobaiocchi, @warmjademe, @smolpaws.
...
<img src="https://champions-list.vercel.app/contributor-wall.svg?v=2026-07-11" alt="OpenHands Champions contributor avatar wall" />
