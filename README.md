...
The directory currently shows **620** visible contributors across **55** public repos, representing **2739** merged PRs.

A few recently active contributors: @mkuri, @aniketwaghh, @enyst, @palrohitg, @aleks-stefanovic, @workvahedi.
...
<img src="https://champions-list.vercel.app/contributor-wall.svg?v=2026-09-16" alt="OpenHands Champions contributor avatar wall" />
