...
The directory currently shows **553** visible contributors across **43** public repos, representing **2552** merged PRs.

A few recently active contributors: @enyst, @dylan-openhands, @smolpaws, @lufen, @ixchio, @rsd-darshan.
...
<img src="https://champions-list.vercel.app/contributor-wall.svg?v=2026-07-16" alt="OpenHands Champions contributor avatar wall" />
