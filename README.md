...
The directory currently shows **600** visible contributors across **52** public repos, representing **2690** merged PRs.

A few recently active contributors: @alanhuangyoo, @simpleqt, @ShashwatXD, @georgeglarson, @dylan-openhands, @JatinJain703.
...
<img src="https://champions-list.vercel.app/contributor-wall.svg?v=2026-09-01" alt="OpenHands Champions contributor avatar wall" />
