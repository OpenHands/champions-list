...
The directory currently shows **544** visible contributors across **43** public repos, representing **2524** merged PRs.

A few recently active contributors: @rakshith1928, @shanemort1982, @enyst, @mvanhorn, @Anrahya, @StatPan.
...
<img src="https://champions-list.vercel.app/contributor-wall.svg?v=2026-07-05" alt="OpenHands Champions contributor avatar wall" />
