...
The directory currently shows **583** visible contributors across **51** public repos, representing **2635** merged PRs.

A few recently active contributors: @smolpaws, @marmar9615-cloud, @karan-963, @mohitdebian, @mvanhorn, @enyst.
...
<img src="https://champions-list.vercel.app/contributor-wall.svg?v=2026-08-19" alt="OpenHands Champions contributor avatar wall" />
