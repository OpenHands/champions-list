...
The directory currently shows **613** visible contributors across **53** public repos, representing **2726** merged PRs.

A few recently active contributors: @enyst, @dylan-openhands, @palrohitg, @georgeglarson, @smolpaws, @lorenzozanee.
...
<img src="https://champions-list.vercel.app/contributor-wall.svg?v=2026-09-11" alt="OpenHands Champions contributor avatar wall" />
