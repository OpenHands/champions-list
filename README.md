...
The directory currently shows **613** visible contributors across **53** public repos, representing **2720** merged PRs.

A few recently active contributors: @palrohitg, @enyst, @georgeglarson, @smolpaws, @lorenzozanee, @simpleqt.
...
<img src="https://champions-list.vercel.app/contributor-wall.svg?v=2026-09-10" alt="OpenHands Champions contributor avatar wall" />
