...
The directory currently shows **554** visible contributors across **44** public repos, representing **2567** merged PRs.

A few recently active contributors: @smolpaws, @harish-chandramowli, @hxaxd, @luciobaiocchi, @dinmukhamedm, @dylan-openhands.
...
<img src="https://champions-list.vercel.app/contributor-wall.svg?v=2026-07-26" alt="OpenHands Champions contributor avatar wall" />
