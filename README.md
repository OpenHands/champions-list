...
The directory currently shows **553** visible contributors across **43** public repos, representing **2554** merged PRs.

A few recently active contributors: @georgeglarson, @dylan-openhands, @enyst, @smolpaws, @lufen, @ixchio.
...
<img src="https://champions-list.vercel.app/contributor-wall.svg?v=2026-07-20" alt="OpenHands Champions contributor avatar wall" />
