...
The directory currently shows **541** visible contributors across **43** public repos, representing **2507** merged PRs.

A few recently active contributors: @enyst, @ysinghc, @sjathin, @tomsen-ai, @georgeglarson, @heyitspratik.
...
<img src="https://champions-list.vercel.app/contributor-wall.svg?v=2026-06-29" alt="OpenHands Champions contributor avatar wall" />
