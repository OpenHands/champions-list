...
The directory currently shows **597** visible contributors across **51** public repos, representing **2674** merged PRs.

A few recently active contributors: @AaronAbuUsama, @ShashwatXD, @dylan-openhands, @georgeglarson, @aartem1, @enyst.
...
<img src="https://champions-list.vercel.app/contributor-wall.svg?v=2026-08-25" alt="OpenHands Champions contributor avatar wall" />
