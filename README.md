...
The directory currently shows **536** visible contributors across **42** public repos, representing **2482** merged PRs.

A few recently active contributors: @enyst, @kimnamu, @Zheng-Lu, @lexcodes-dev, @bozhnyukAlex, @GautamKumarOffical.
...
<img src="https://champions-list.vercel.app/contributor-wall.svg?v=2026-06-22" alt="OpenHands Champions contributor avatar wall" />
