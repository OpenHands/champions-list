...
The directory currently shows **552** visible contributors across **43** public repos, representing **2546** merged PRs.

A few recently active contributors: @ixchio, @rsd-darshan, @smolpaws, @xli04, @mvanhorn, @georgeglarson.
...
<img src="https://champions-list.vercel.app/contributor-wall.svg?v=2026-07-14" alt="OpenHands Champions contributor avatar wall" />
