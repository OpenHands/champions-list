...
The directory currently shows **525** visible contributors across **43** public repos, representing **2438** merged PRs.

A few recently active contributors: @enyst, @Hades32, @Fieldnote-Echo, @muff-c, @smolpaws, @shanemort1982.
...
<img src="https://champions-list.vercel.app/contributor-wall.svg?v=2026-06-11" alt="OpenHands Champions contributor avatar wall" />
