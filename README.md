...
The directory currently shows **616** visible contributors across **53** public repos, representing **2731** merged PRs.

A few recently active contributors: @BORAN002, @dylan-openhands, @Tyagiquamar, @Chocolatine75, @enyst, @palrohitg.
...
<img src="https://champions-list.vercel.app/contributor-wall.svg?v=2026-09-13" alt="OpenHands Champions contributor avatar wall" />
