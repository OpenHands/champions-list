...
The directory currently shows **590** visible contributors across **51** public repos, representing **2656** merged PRs.

A few recently active contributors: @keeltrace, @harish-chandramowli, @onatozmenn, @dylan-openhands, @marmar9615-cloud, @Linxiushen.
...
<img src="https://champions-list.vercel.app/contributor-wall.svg?v=2026-08-22" alt="OpenHands Champions contributor avatar wall" />
