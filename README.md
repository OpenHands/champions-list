...
The directory currently shows **604** visible contributors across **53** public repos, representing **2699** merged PRs.

A few recently active contributors: @trungminhdo4-glitch, @georgeglarson, @sideeffffect, @Shimada666, @lzhan011, @dylan-openhands.
...
<img src="https://champions-list.vercel.app/contributor-wall.svg?v=2026-09-03" alt="OpenHands Champions contributor avatar wall" />
