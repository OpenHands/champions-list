...
The directory currently shows **611** visible contributors across **53** public repos, representing **2711** merged PRs.

A few recently active contributors: @simpleqt, @BSmick6, @vnktadithya, @imitater-dou, @lzhan011, @LosAveRoad.
...
<img src="https://champions-list.vercel.app/contributor-wall.svg?v=2026-09-07" alt="OpenHands Champions contributor avatar wall" />
