...
The directory currently shows **553** visible contributors across **43** public repos, representing **2553** merged PRs.

A few recently active contributors: @dylan-openhands, @enyst, @smolpaws, @lufen, @ixchio, @rsd-darshan.
...
<img src="https://champions-list.vercel.app/contributor-wall.svg?v=2026-07-18" alt="OpenHands Champions contributor avatar wall" />
