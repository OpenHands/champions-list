...
The directory currently shows **543** visible contributors across **43** public repos, representing **2522** merged PRs.

A few recently active contributors: @enyst, @mvanhorn, @Anrahya, @StatPan, @ly-wang19, @smolpaws.
...
<img src="https://champions-list.vercel.app/contributor-wall.svg?v=2026-07-03" alt="OpenHands Champions contributor avatar wall" />
