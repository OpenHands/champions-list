...
The directory currently shows **540** visible contributors across **43** public repos, representing **2504** merged PRs.

A few recently active contributors: @sjathin, @tomsen-ai, @georgeglarson, @enyst, @heyitspratik, @nehaaprasad.
...
<img src="https://champions-list.vercel.app/contributor-wall.svg?v=2026-06-28" alt="OpenHands Champions contributor avatar wall" />
