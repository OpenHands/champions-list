...
The directory currently shows **553** visible contributors across **43** public repos, representing **2548** merged PRs.

A few recently active contributors: @lufen, @smolpaws, @ixchio, @rsd-darshan, @xli04, @mvanhorn.
...
<img src="https://champions-list.vercel.app/contributor-wall.svg?v=2026-07-15" alt="OpenHands Champions contributor avatar wall" />
