...
The directory currently shows **534** visible contributors across **42** public repos, representing **2473** merged PRs.

A few recently active contributors: @enyst, @bozhnyukAlex, @GautamKumarOffical, @sanjibani, @joelhans, @wgu9.
...
<img src="https://champions-list.vercel.app/contributor-wall.svg?v=2026-06-19" alt="OpenHands Champions contributor avatar wall" />
