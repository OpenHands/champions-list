...
The directory currently shows **543** visible contributors across **43** public repos, representing **2523** merged PRs.

A few recently active contributors: @shanemort1982, @enyst, @mvanhorn, @Anrahya, @StatPan, @ly-wang19.
...
<img src="https://champions-list.vercel.app/contributor-wall.svg?v=2026-07-04" alt="OpenHands Champions contributor avatar wall" />
