...
The directory currently shows **554** visible contributors across **44** public repos, representing **2566** merged PRs.

A few recently active contributors: @reacher-z, @smolpaws, @harish-chandramowli, @hxaxd, @luciobaiocchi, @dinmukhamedm.
...
<img src="https://champions-list.vercel.app/contributor-wall.svg?v=2026-07-27" alt="OpenHands Champions contributor avatar wall" />
