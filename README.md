...
The directory currently shows **640** visible contributors across **57** public repos, representing **2785** merged PRs.

A few recently active contributors: @georgeglarson, @jabrailkhalil, @Harsh23Kashyap, @shinji00222, @errmakov, @FOWEPJF255.
...
<img src="https://champions-list.vercel.app/contributor-wall.svg?v=2026-09-26" alt="OpenHands Champions contributor avatar wall" />
